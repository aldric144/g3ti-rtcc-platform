...
function ProbabilityBadge({ probability }: { probability: number }) {
  ...
  const getColor = () => {
    ...
    if (percentage >= 60) return 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400';
...
function PredictionCard({ prediction }: { prediction: Prediction }) {
  ...
  return (
    <div
      className="rounded-lg border border-gray-200 bg-gray-50 p-3 dark:border-gray-700 dark:bg-gray-800/50 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800"
