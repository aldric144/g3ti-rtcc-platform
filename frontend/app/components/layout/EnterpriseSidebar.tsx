...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/robots', label: 'Robots', icon: Bot },
      { href: '/admin/sectors', label: 'Sectors', icon: Map },
      { href: '/admin/lpr-zones', label: 'LPR Zones', icon: Car },
      { href: '/admin/fire-preplans', label: 'Fire Preplans', icon: AlertTriangle },
      { href: '/admin/infrastructure', label: 'Infrastructure', icon: Building2 },
      { href: '/admin/schools', label: 'Schools', icon: Users },
      { href: '/admin/dv-risk-homes', label: 'DV Risk Homes', icon: Heart },
      { href: '/admin/incidents', label: 'Incidents', icon: AlertCircle },
      { href: '/admin/api-connections', label: 'API Connections', icon: Network },
      { href: '/admin/events', label: 'Events', icon: Bell },
      { href: '/admin/hydrants', label: 'Hydrants', icon: Waves },
    ],
    roles: ['admin', 'supervisor', 'system-integrator'],
  },
  {
    id: 'system-admin',
    label: 'System Admin',
